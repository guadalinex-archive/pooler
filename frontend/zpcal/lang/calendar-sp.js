...
Zapatec.Calendar._TT["INFO"] = "Informaci&oacute;n del Calendario";
...
"\n\n" +
"Seleccion de Fechas:\n" +
"- Use  \xab, \xbb para seleccionar el anyo\n" +
"- Use " + String.fromCharCode(0x2039) + ", " + String.fromCharCode(0x203a) + " para seleccionar el mes\n" +
"- Mantenga presionado el boton del raton en cualquiera de las opciones superiores para un acceso rapido .";
Zapatec.Calendar._TT["ABOUT_TIME"] = "\n\n" +
"Selección del Reloj:\n" +
"- Seleccione la hora para cambiar el reloj\n" +
"- o presione  Shift-click para disminuirlo\n" +
"- o presione click y arrastre del raton para una seleccion rapida.";

Zapatec.Calendar._TT["PREV_YEAR"] = "A&ntilde;o anterior (Presione para menu)";
...
Zapatec.Calendar._TT["NEXT_YEAR"] = "A&ntilde;o Siguiente (Presione para menu)";
