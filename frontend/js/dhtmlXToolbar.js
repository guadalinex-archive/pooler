 ...
 for(var i=0;i<temp1.length;i++)
{
 ...
 dhtmlXSelectButtonObject.prototype.getOptionValue=function(){
...
dhtmlXTwoStateButtonObject.prototype._onclickX = function(e,that){
 ...
 dhtmlXToolbarObject.prototype.setText=function(text){
 	var tds = this.topNod.firstChild.firstChild.childNodes;
 	tds[tds.length-2].innerHTML = text;
 };
 
 dhtmlXToolbarObject.prototype.refreshDisplay=function(){
 	this.topNod.style.display="";
 }

function dhtmlXInputTextObject(elem,width,height,className)
{
 if(elem.tagName=="InputText")
{
 ...
 dhtmlXInputTextObject.prototype = new dhtmlXButtonPrototypeObject;
 
 dhtmlXInputTextObject.prototype.clearField=function(){
 this.inElement.value = '';
};

 dhtmlXInputTextObject.prototype.getValue=function(){
