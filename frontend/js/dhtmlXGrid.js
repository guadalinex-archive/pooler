...
dhtmlXGridObject.prototype.getNode = function(tagName){
	return this.xmlLoader.getXMLTopNode(tagName);
}

dhtmlXGridObject.prototype.isLoadedXML = function(){
	return (this._xml_ready || false);
}

dhtmlXGridObject.prototype.getRowsXPath = function(xpathExp){
...
dhtmlXGridObject.prototype.setOnEndLoad = function(func){
	if(typeof(func) == 'function')
		this.onEndLoad = func;
}
