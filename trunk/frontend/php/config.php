 ...
 */
	...
	define('REPO_CONF', '/home/admin/pooler/conf/repo.conf'); $repo_conf = REPO_CONF;
	define('ADD_PKG_PY', '/home/admin/pooler/trunk/backend/addpkg.py'); $add_pkg_py = ADD_PKG_PY;
	define('MV_PKG_PY', '/home/admin/pooler/trunk/backend/mvpkg.py'); $mv_pkg_py = MV_PKG_PY;
	define('RM_PKG_PY', '/home/admin/pooler/trunk/backend/rmpkg.py'); $rm_pkg_py = RM_PKG_PY;
