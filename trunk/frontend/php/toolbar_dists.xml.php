...
echo '<toolbar name=" " width="250" toolbarAlign="left">';
	...
	if($dists = getAccessDists()){
		...
		echo '<ImageButton src="../img/arbol2.gif" height="25" width="25" id="but_dists_4" tooltip="Desplegar Arbol" />';
		echo '<ImageButton src="../img/arbol3.gif" height="25" width="25" id="but_dists_5" tooltip="Replegar Arbol" />';	
		echo '<ImageButton src="../img/reload.gif" height="25" width="25" id="but_dists_6" tooltip="Refrescar Arbol" />';
		echo '<divider id="div_2"/>';
	}
	
	echo '<ImageButton src="../img/s_loggoff.png" height="25" width="25" id="but_dists_7" tooltip="Salir" />';	
echo '</toolbar>';
/*****************************************************************************/
