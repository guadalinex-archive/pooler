	...
	<tr>
		...
		<td>
			<table class="table1" cellspacing="0" cellpadding="0">
				<tr>
					<td><input type="checkbox" id="chk_pck" value="pck" <?= eregi('pck', $uparam['app']) ? 'checked="true"' : (!$user ? 'checked="true"' : '') ?> /></td><td>Packages&nbsp;&nbsp;&nbsp;</td>
					<td><input type="checkbox" id="chk_user" value="user" <?= eregi('user', $uparam['app']) ? 'checked="true"' : '' ?> /></td><td>Usuarios&nbsp;&nbsp;&nbsp;</td>
					<td><input type="checkbox" id="chk_log" value="log" <?= eregi('log', $uparam['app']) ? 'checked="true"' : '' ?> /></td><td>Log</td>
				</tr>
			</table>
		</td>
	</tr>
