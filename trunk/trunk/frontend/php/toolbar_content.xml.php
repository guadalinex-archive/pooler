...
echo '<toolbar name="Listado de Paquetes" width="645" toolbarAlign="left">';
	...
	if($dists = getAccessDists() and isset($_GET['path']) and !empty($_GET['path'])){
		...
		echo '<ImageButton src="../img/b_prevpage.png" width="20" height="25" id="but_content_4" tooltip="Anterior pagina"  />';
		echo '<ImageButton src="../img/b_nextpage.png" width="15" height="25" id="but_content_5" tooltip="Siguiente pagina"  />';	
